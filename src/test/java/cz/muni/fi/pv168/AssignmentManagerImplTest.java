...
public class AssignmentManagerImplTest {
    ...
    public void testCreateAssignment() throws Exception {
        ...
        assertThat(manager.getAssignment(ass1.getId())).isNull();
    ...
    public void testFindAssignmentsOfMission() throws Exception {
        ...
        List<Assignment> listForM1 = new ArrayList<Assignment>();
        listForM1.add(ass1);
        assertThat(manager.findAssignmentsOfMission(m1)).isEqualTo(listForM1);

        List<Assignment> listForM2 = new ArrayList<Assignment>();
        listForM2.add(ass1);
        listForM2.add(ass3);
    ...
    public void testFindActualAssignmentOfAgent() throws Exception {
        ...
        List<Assignment> listForAg1 = new ArrayList<Assignment>();
        listForAg1.add(ass2);
        assertThat(manager.findActualAssignmentOfAgent(ag1)).isEqualTo(listForAg1);

        List<Assignment> listForAg3 = new ArrayList<Assignment>();
        listForAg3.add(ass4);
